/**
 * Copy and paste of body-scroll-lock plugin with some functions changed
 * API for use remains the exact same as bodyScrollLock for interoperability
 */
...
const setOverflowHidden = options => {
  ...
  if (previousBodyPaddingRight === undefined) {
    ...
    if (reserveScrollBarGap && scrollBarGap > 0) {
      ...
      document.documentElement.style.paddingRight = `${computedBodyPaddingRight + scrollBarGap}px`;
    }
  }
