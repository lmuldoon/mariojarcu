...
/***/ "./assets/src/js/scripts/body-scroll-lock-facade.js":
/*!**********************************************************!*\
  !*** ./assets/src/js/scripts/body-scroll-lock-facade.js ***!
  \**********************************************************/
...
var setOverflowHidden = function setOverflowHidden(options) {
  ...
  if (previousBodyPaddingRight === undefined) {
    ...
    if (reserveScrollBarGap && scrollBarGap > 0) {
      ...
      document.documentElement.style.paddingRight = "".concat(computedBodyPaddingRight + scrollBarGap, "px");
    }
...
var restoreOverflowSetting = function restoreOverflowSetting() {
  if (previousBodyPaddingRight !== undefined) {
    document.documentElement.style.paddingRight = previousBodyPaddingRight; // Restore previousBodyPaddingRight to undefined so setOverflowHidden knows it
    // can be set again.
  ...
  if (previousBodyOverflowSetting !== undefined) {
    document.documentElement.style.overflow = previousBodyOverflowSetting; // Restore previousBodyOverflowSetting to undefined
...
/***/ "./assets/src/js/scripts/mobile-nav.js":
/*!*********************************************!*\
  !*** ./assets/src/js/scripts/mobile-nav.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initMobileNav; }
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _body_scroll_lock_facade__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./body-scroll-lock-facade */ "./assets/src/js/scripts/body-scroll-lock-facade.js");


function initMobileNav() {
  var toggle = document.querySelector('.js-site-nav-toggle');
  var closeBtn = document.querySelector('.js-site-nav-close');
  var shade = document.querySelector('.js-menu-body-shade');
  var panel = document.getElementById('mobile-nav');
  if (!toggle || !panel) return;
  var animatedItems = panel.querySelectorAll('.mobile-nav__list li, .mobile-nav__footer'); // Resting (closed) state for the nav items, set once up front so there's
  // no flash of visible content before the first open.

  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(animatedItems, {
    opacity: 0,
    x: 24
  });
  ...
  var open = function open() {
    ...
    shade === null || shade === void 0 ? void 0 : shade.classList.add('is-open');
    toggle.classList.add('is-active');
    toggle.setAttribute('aria-expanded', 'true');
    (0,_body_scroll_lock_facade__WEBPACK_IMPORTED_MODULE_0__.disableBodyScroll)(panel, {
      reserveScrollBarGap: true
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(animatedItems, {
      opacity: 1,
      x: 0,
      duration: 0.45,
      ease: 'power3.out',
      stagger: 0.06,
      delay: 0.15,
      // let the panel start sliding in first
      overwrite: true
    });
  };
  ...
  var close = function close() {
    ...
    shade === null || shade === void 0 ? void 0 : shade.classList.remove('is-open');
    toggle.classList.remove('is-active');
    toggle.setAttribute('aria-expanded', 'false');
    (0,_body_scroll_lock_facade__WEBPACK_IMPORTED_MODULE_0__.enableBodyScroll)(panel);
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(animatedItems, {
      opacity: 0,
      x: 24,
      duration: 0.25,
  ...
  shade === null || shade === void 0 ? void 0 : shade.addEventListener('click', close);
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scripts_mobile_nav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/mobile-nav */ "./assets/src/js/scripts/mobile-nav.js");

document.addEventListener('DOMContentLoaded', function () {
  (0,_scripts_mobile_nav__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
}();
/******/ })()
;
