...
/***/ "./assets/src/js/scripts/__event-utilities.js":
/*!****************************************************!*\
  !*** ./assets/src/js/scripts/__event-utilities.js ***!
  \****************************************************/
...
/***/ "./assets/src/js/scripts/__tools.js":
/*!******************************************!*\
  !*** ./assets/src/js/scripts/__tools.js ***!
  \******************************************/
/***/ (function() {
...
/***/ "./assets/src/js/scripts/animations.js":
/*!*********************************************!*\
  !*** ./assets/src/js/scripts/animations.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getAnchorScrollOffset": function() { return /* binding */ getAnchorScrollOffset; },
/* harmony export */   "initAnimations": function() { return /* binding */ initAnimations; },
/* harmony export */   "progressTimeline": function() { return /* binding */ progressTimeline; },
/* harmony export */   "refreshAnimations": function() { return /* binding */ refreshAnimations; },
/* harmony export */   "toggleScroll": function() { return /* binding */ toggleScroll; }
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _event_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./__event-utilities */ "./assets/src/js/scripts/__event-utilities.js");
...
function initAnimations() {
  ...
  animateElements();
  animateHeaderIn();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').removeClass('no-gsap').addClass('gsap');
}

function init() {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger);
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_Flip__WEBPACK_IMPORTED_MODULE_4__.Flip);
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.config({
...
function setUpHeader() {
  ...
  function storeHeaderHeight() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').css('--header-height', "".concat(Math.ceil($siteHeader.outerHeight(true)), "px"));
  }

  storeHeaderHeight();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', (0,_event_utilities__WEBPACK_IMPORTED_MODULE_1__.debounce)(storeHeaderHeight, 150));
}
/**
...
function animateParallax() {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".parallax-up").forEach(function (item) {
    var parallaxUp = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline();
    var content = jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).find('.parallax-up--element');
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".parallax").forEach(function (image) {
    var parallax = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline(),
        img = jquery__WEBPACK_IMPORTED_MODULE_0___default()(image).find('img');
    parallax.set(img, {
      scale: 1.2
    }).to(img, {
      scale: 1
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
      ...
      scrub: true,
      once: false,
      end: 'bottom center' //onLeave: () => ScrollTrigger.refresh(),
...
function initBentoGallery() {
  var createTween = function createTween() {
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.disable();
    var galleryElement = document.querySelector(".gallery--bento");
    var galleryItems = galleryElement.querySelectorAll(".gallery__item");
    var galleryItemCaption = galleryElement.querySelectorAll(".gallery__item__caption");
    flipCtx && flipCtx.revert();
    galleryElement.classList.remove("gallery--final");
    flipCtx = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.context(function () {
      // Temporarily add the final class to capture the final state
      galleryElement.classList.add("gallery--final");
      var flipState = gsap_Flip__WEBPACK_IMPORTED_MODULE_4__.Flip.getState(galleryItems);
      galleryElement.classList.remove("gallery--final");
      var flip = gsap_Flip__WEBPACK_IMPORTED_MODULE_4__.Flip.to(flipState, {
        simple: true
      });
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.enable();
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
        ...
        onUpdate: function onUpdate(self) {
          if (self.progress > 0.9) {
            gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(galleryItemCaption, {
              duration: 0.3,
              autoAlpha: 1
            });
          } else {
      ...
      animateElements();
      return function () {
        return gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(galleryItems, {
          clearProps: "all"
        });
      };
    });
...
function animateElements() {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".animated").forEach(function (elem, index) {
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(elem.children, {
      opacity: 0
    });
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
      trigger: elem,
      ...
      onEnter: function onEnter() {
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.fromTo(elem.children, {
          y: 50,
          autoAlpha: 0
        }, {
          y: 0,
      ...
      onEnterBack: function onEnterBack() {
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(elem.children, {
          duration: 0.3,
          autoAlpha: 1,
          stagger: 0.05
        });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".featured-angle-left").forEach(function (elem, index) {
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
      trigger: elem,
      toggleClass: 'cropped',
      once: true
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".image-text__image__wrapper").forEach(function (elem, index) {
    var mm = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.matchMedia();
    ...
    mm.add("(max-width: 1279px)", function () {
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(elem, {
        autoAlpha: 0
      });
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
...
function animateHeaderIn() {
  ...
  var navItems = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".site-nav__item");
  var bookBtn = document.querySelector(".site-header__book-btn");
  var targets = [logo].concat(_toConsumableArray(navItems), [bookBtn]).filter(Boolean);

  if (!targets.length) {
    return;
  }

  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(targets, {
    y: -16,
    autoAlpha: 0
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(targets, {
    y: 0,
    autoAlpha: 1,
    duration: 0.6,
    ease: "power3.out",
...
/***/ "./assets/src/js/scripts/gallery-lightbox.js":
/*!***************************************************!*\
  !*** ./assets/src/js/scripts/gallery-lightbox.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initGalleryLightbox; }
/* harmony export */ });
function initGalleryLightbox() {
  ...
  var open = function open(src, alt) {
  ...
  document.addEventListener('click', function (event) {
    ...
    if (tile) {
      ...
      event.preventDefault();
      open(tile.getAttribute('data-full'), (_tile$querySelector = tile.querySelector('img')) === null || _tile$querySelector === void 0 ? void 0 : _tile$querySelector.getAttribute('alt'));
      return;
    }
...
/***/ "./assets/src/js/scripts/init.swiper.js":
/*!**********************************************!*\
  !*** ./assets/src/js/scripts/init.swiper.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ initReviewsCarousel; }
/* harmony export */ });
...
function initReviewsCarousel() {
  var el = document.querySelector('.js-reviews-carousel');
  if (!el) return;
...
_makeAbsolute = function _makeAbsolute(elState, fallbackNode, ignoreBatch) {
  ...
  // in _fromTo(), we store the inline styles temporarily when nested is true, and the Array is like [element, styles1, styles2, element, styles1, styles2, ...] where styles1 is one state and styles2 is another state (the element.getAttribute("style")).
  ...
  for (p in toState.idLookup) {
    ...
    if (fromNode) {
      ...
      if (comp.sd) {
        // from and to elements are different, so we need to swap them.
        if (comp.sd < 0) {
          comp.b = toNode;
          comp.a = fromNode;
    ...
    for (i = 0; i < comps.length; i++) {
      ...
      if (prune && !a.isDifferent(b) && !comp.entering) {
        ...
        if (nested && !(comp.sd < 0) && i) {
          ...
          a = comp.a = a.clone({
            matrix: (0,_utils_matrix_js__WEBPACK_IMPORTED_MODULE_0__.getGlobalMatrix)(el, false, false, true)
          });
        }
...
var ElementState = /*#__PURE__*/function () {
  function ElementState(element, props, simple) {
    if (element instanceof ElementState) {
      // allows us to essentially clone
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scripts_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/__tools */ "./assets/src/js/scripts/__tools.js");
/* harmony import */ var _scripts_tools__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scripts_tools__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _scripts_init_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/init.swiper */ "./assets/src/js/scripts/init.swiper.js");
/* harmony import */ var _scripts_gallery_lightbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/gallery-lightbox */ "./assets/src/js/scripts/gallery-lightbox.js");
/* harmony import */ var _scripts_animations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/animations */ "./assets/src/js/scripts/animations.js");
...
function whenFontsReady(callback) {
  var timeoutMs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1500;
  ...
  Promise.race([document.fonts.ready, new Promise(function (resolve) {
    return setTimeout(resolve, timeoutMs);
  })]).then(callback);
}

whenFontsReady(_scripts_animations__WEBPACK_IMPORTED_MODULE_3__.initAnimations);
document.addEventListener('DOMContentLoaded', function () {
  (0,_scripts_init_swiper__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_scripts_gallery_lightbox__WEBPACK_IMPORTED_MODULE_2__["default"])();
});
  ...
  if (window.location.hash) {
    ...
    if ($hashTarget.length) {
      $(window).on('load', function () {
        var headerHeight = (0,_scripts_animations__WEBPACK_IMPORTED_MODULE_3__.getAnchorScrollOffset)();
